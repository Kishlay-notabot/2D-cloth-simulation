...
# def join_two(thing, thing2):
#     bruh = pymunk.DampedSpring(thing, thing2, (0, 0), (0, 0), 100, 100, 10)
#     space.add(bruh)
...
def run(window, wid, hei):
    ...
    joina = create_ball_a(space, 5, 10)
    joinb = create_ball_b(space, 5, 10)
    j = pymunk.DampedSpring(big_ball.body, joina.body, (0, 0), (0, 0), 100, 100, 10)
    space.add(j)
    k = pymunk.DampedSpring(big_ball.body, joinb.body, (0, 0), (0, 0), 100, 100, 10)
    space.add(k)
    # join_two(joina, joinb)
    wall(space, wid, hei)
    draw_options = pymunk.pygame_util.DrawOptions(window)
